...
import { faEnvelope, faUnlockAlt, faUser, faLocation, faSpinner, faPhone } from "@fortawesome/free-solid-svg-icons";
...
function Register() {
  ...
  const canSubmit = formData.email.length > 0 && formData.password.length > 0 && formData.name.length > 0 && formData.mobile.length > 0 && !loading;
      ...
      <Form className="mt-4" onSubmit={handleSubmit}>
        <Form.Group id="name" className="mb-4">
          ...
          <InputGroup>
            ...
            <Form.Control autoFocus required name="name" type="text" placeholder="Jane Doe" onChange={handleChange} />
          </InputGroup>
        </Form.Group>
        ...
        <Form.Group id="mobile" className="mb-4">
          ...
          <InputGroup>
            ...
            <Form.Control autoFocus required name="mobile" type="text" placeholder="Mobile Number" onChange={handleChange} />
          </InputGroup>
        </Form.Group>
        <Row>
          <Col>
            <Button variant="primary" type="submit" className="w-100" disabled={!canSubmit}>
              Register
            </Button>
          </Col>
          {loading && (
